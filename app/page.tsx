...
export default function Home() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
      ...
      {/* Hero title */}
      <Reveal delay={0.2}>
        <h1 className="z-10 mt-6 sm:mt-8 px-2 text-4xl sm:text-6xl md:text-8xl font-extrabold tracking-tight text-transparent bg-clip-text bg-white/90 text-edge-outline whitespace-nowrap">
          {siteConfig.name}
        </h1>
      </Reveal>
      ...
      <Reveal delay={0.4}>
        <div className="my-10 sm:my-12 text-center px-4">

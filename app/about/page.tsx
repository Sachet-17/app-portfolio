...
export default function AboutPage() {
  return (
    <main className={`${inter.className} mx-auto max-w-5xl px-6 pt-48 pb-16`}>
      ...
      {/* --- hard spacer to always clear the fixed nav (belt + suspenders) --- */}
      <div className="h-2" />

      {/* PAGE HEADING (same vibe as Projects) */}
        ...
        <div className="relative p-6 md:p-10 lg:p-12">
          <div className="grid gap-10 md:grid-cols-[auto,1fr] items-start">
            ...
            <div className="w-80 h-80 overflow-hidden rounded-2xl border border-zinc-800">
              <Image
                src="/headshots.jpg" // make sure this exists in /public
      ...
      {/* ===== Card 2: Interests & Focus (with its own heading) ===== */}
      <div className="mt-10">
        <Card>

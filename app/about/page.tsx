...
// keep Typing available if you want to re-enable later (not shown in UI below)
    ...
    <main className={`${inter.className} mx-auto max-w-5xl px-6 pt-32 pb-16`}>
      ...
      <section className="mb-12">
        ...
        <p className="mt-4 max-w-2xl text-zinc-400 text-lg">
          About - Computer Engineering grad (NYU) building scalable backends and ML-powered apps across AWS, GCP, and Azure.
        </p>
      </section>

      {/* Optional faint background wash like Projects */}
      ...
      <div className="grid gap-10 md:grid-cols-[auto,1fr] items-start">
        ...
        <div className="w-80 h-80 overflow-hidden rounded-2xl border border-zinc-800">
          <Image
            src="/headshots.jpg"   // ensure this exists at /public/headshots.jpg
        ...
        <div className="space-y-4 text-zinc-300 leading-relaxed">
          <p>
            ...
            experience in software development, backend engineering, and AI/ML model deployment.
            I’ve built scalable APIs, optimized backend systems for high performance, and
            deployed intelligent applications across cloud platforms like AWS, GCP, and Azure.
          </p>
          <p>
          ...
          {/* Quick facts (like small meta under project headers) */}
      ...
      {/* Divider like the one before project lists */}
